...
# Demo mode compresses real-time intervals for testing/demo purposes.
# Set ADHD_OS_DEMO_MODE=1 to enable compressed timing.
DEMO_MODE = os.environ.get("ADHD_OS_DEMO_MODE", "0") == "1"
...
class BodyDoubleMachine:
    ...
    async def _monitoring_loop(self, interval_minutes: int):
        ...
        # In demo mode, compress intervals to 3 seconds each
...
class FocusTimerMachine:
    ...
    async def _warning_loop(self, total_minutes: int):
        ...
        # In demo mode, compress: 1 minute = 0.1 seconds
